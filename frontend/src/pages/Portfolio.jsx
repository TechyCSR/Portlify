...
function Portfolio() {
    ...
    const { basicDetails, skills, experience, education, projects, achievements, socialLinks } = profile
            ...
            <section className="relative pt-16 pb-12 overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        >
                            <div className="w-32 h-32 rounded-3xl p-1 shadow-2xl"
                                style={{ background: 'var(--gradient-primary)', boxShadow: 'var(--shadow-glow)' }}>
                                <div className="w-full h-full rounded-[20px] flex items-center justify-center overflow-hidden"
                            ...
                            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-xs font-medium"
                                style={{ background: 'rgba(16, 185, 129, 0.2)', color: 'rgb(52, 211, 153)', border: '1px solid rgba(16, 185, 129, 0.3)' }}>
                                ● Available
                            </div>
                        </motion.div>
                        ...
                        {basicDetails?.location && (
                            <motion.p
                                ...
                                className="text-tertiary flex items-center justify-center gap-2"
                            >
                ...
                >
                    <div className="flex gap-4 animate-scroll">
                        {[...allSkills, ...allSkills].map((skill, i) => (
                            <span
                                key={i}
                                className="px-4 py-2 rounded-full text-sm whitespace-nowrap glass"
                            >
                                {skill}
                            </span>
                        ))}
                                ...
                                <div className="glass-card rounded-3xl p-8">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        {skills?.technical?.length > 0 && (
                                            <div>
                                                <h3 className="text-sm font-medium mb-3 uppercase tracking-wide" style={{ color: 'var(--color-primary-400)' }}>
                                                    Technical
                                                </h3>
                                                <div className="flex flex-wrap gap-2">
                                                    {skills.technical.map((skill, i) => (
                                                        <span key={i} className="px-3 py-1.5 rounded-lg text-sm"
                                                            style={{ background: 'rgba(99, 102, 241, 0.2)', color: 'var(--color-primary-300)' }}>
                                                            {skill}
                                                        </span>
                                                    ))}
                                                </div>
                                        ...
                                        {skills?.tools?.length > 0 && (
                                            <div>
                                                <h3 className="text-sm font-medium mb-3 uppercase tracking-wide" style={{ color: 'var(--color-accent-400)' }}>
                                                    Tools & Platforms
                                                </h3>
                                                <div className="flex flex-wrap gap-2">
                                        ...
                                        {skills?.soft?.length > 0 && (
                                            <div>
                                                <h3 className="text-sm font-medium text-emerald-400 mb-3 uppercase tracking-wide">Soft Skills</h3>
                                                <div className="flex flex-wrap gap-2">
                                                    {skills.soft.map((skill, i) => (
                                                        <span key={i} className="px-3 py-1.5 rounded-lg text-sm"
                                                            style={{ background: 'rgba(16, 185, 129, 0.2)', color: 'rgb(52, 211, 153)' }}>
                                                            {skill}
                                                        </span>
                                                    ))}
                                                </div>
                                        ...
                                        {skills?.languages?.length > 0 && (
                                            <div>
                                                <h3 className="text-sm font-medium text-amber-400 mb-3 uppercase tracking-wide">Languages</h3>
                                                <div className="flex flex-wrap gap-2">
                                ...
                                >
                                    ...
                                    <div className="pl-4">
                                        <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                                            ...
                                            <span className="text-muted text-sm">{exp.duration}</span>
                                        </div>
                                    ...
                                    <div className="flex gap-4">
                                        {proj.demoUrl && (
                                            <a
                                                ...
                                                className="flex items-center gap-2 text-sm font-medium heading-gradient"
                                            >
                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
