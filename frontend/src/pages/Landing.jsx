...
function Landing() {
    ...
    return (
        <div className="min-h-screen overflow-hidden">
                        ...
                        <SignedOut>
                            <Link to="/sign-up">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="group flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-white text-lg shadow-xl shadow-primary-500/25 transition-all"
                            ...
                            <Link to="/sign-in">
                                <motion.button
                                    ...
                                    className="px-8 py-4 rounded-xl font-semibold text-secondary border border-border hover:border-primary-500/50 transition-all"
                                >
                                    Sign In
                                </motion.button>
                            </Link>
            ...
            {/* Stats Section */}
            <section className="py-20 px-4 border-y" style={{ borderColor: 'var(--color-border)' }}>
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {stats.map((stat, i) => (
                            ...
                            >
                                <div className="text-4xl md:text-5xl font-display font-bold heading-gradient mb-2">
                                    {stat.value}
                                </div>
                                <div className="text-tertiary font-medium">{stat.label}</div>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-secondary max-w-2xl mx-auto">
                            Three simple steps to transform your resume into a professional portfolio
                        </p>
                    </motion.div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {[
                            ...
                            { title: 'SEO Optimized', desc: 'Built-in SEO ensures your portfolio ranks well in search results.' }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                        ...
                        <SignedOut>
                            <Link to="/sign-up">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="inline-flex items-center gap-2 px-10 py-4 rounded-xl font-semibold text-white text-lg shadow-xl shadow-primary-500/25"
                                    style={{ background: 'var(--gradient-primary)' }}
                                >
                                    Get Started Free
                                    <ArrowRightIcon />
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <p className="text-muted text-sm">
                            © 2026 Portlify. Built for professionals.
                        </p>
                    </div>
                </div>
            </footer>
